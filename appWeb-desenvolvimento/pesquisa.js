    ...
    try {
        ...
        for (let i = 0; i < resultados.length; i++) {
            ...
            if (parteResultados.length === objetosPorArquivo || i === resultados.length - 1) {
                ...
                const caminhoCompleto = path.join(leadsFolderPath, parteNomeArquivo);

                // Certifique-se de que a pasta 'leads' exista antes de salvar o arquivo
                await fs.mkdir(leadsFolderPath, { recursive: true });
